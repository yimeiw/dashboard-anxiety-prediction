<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('prediction.result.view') }}" :active="request()->routeIs('prediction.result.view')">
    ...
    <div :class="{'translate-x-0': open, '-translate-x-full': !open}"
        ...
        <div class="flex-1 overflow-y-auto">
            ...
            <div class="py-1 space-y-1 border-b border-gray-200">
                <x-responsive-nav-link href="{{ route('prediction.result.view') }}" :active="request()->routeIs('prediction.result.view')"
                                      class="block px-4 py-3 text-base font-medium">
                    {{ __('Prediction Result') }}
                </x-responsive-nav-link>
            </div>
